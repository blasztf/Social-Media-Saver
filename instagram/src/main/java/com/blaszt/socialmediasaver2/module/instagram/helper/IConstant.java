...
public class IConstant {
    ...
    public static final String API_FETCH_HEADERS = "si/fetch_headers/?challenge_type=signup&guid=%s";

    public static final String API_SEARCH_USERNAME = "users/%s/usernameinfo/";

    public static final String API_USER_STORY_FEED = "feed/user/%s/story/";

    public static final String API_SYNC_FEATURES = "qe/sync/";

    public static final String API_AUTO_COMPLETE_USER_LIST = "friendships/autocomplete_user_list/";

    public static final String API_GET_INBOX = "direct_v2/inbox/?";

    public static final String API_GET_RECENT_ACTIVITY = "news/inbox/?";
