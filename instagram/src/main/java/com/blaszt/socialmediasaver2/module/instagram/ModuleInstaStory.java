...
//
//    public ModuleInstaStory(String url) throws URLNotValid {
//        url = sanitizeUrl(url);
//        if (!isValid(url)) {
...
//        List<InstagramFeedItem> stories = null;
//
//        loginInstagram();
//
...
//                        case MEDIA_IMAGE:
//                            collections[i] = chooseBestImageUrlCandidate(stories.get(i).getImage_versions2().getCandidates());
//                            break;
//                        case MEDIA_VIDEO:
//                            collections[i] = chooseBestVideoUrlCandidate(stories.get(i).getVideo_versions());
//                            break;
//                    }
//                }
//            }
...
//    }
//
//    private String chooseBestImageUrlCandidate(List<InstagramCandidate> list) {
//        InstagramCandidate bestImageMeta = null;
//
//        for (InstagramCandidate imageMeta : list) {
...
//    }
//
//    private String chooseBestVideoUrlCandidate(List<InstagramVideoVersions> list) {
//        InstagramVideoVersions bestImageMeta = null;
//
//        for (InstagramVideoVersions imageMeta : list) {
//            if (bestImageMeta == null) {
//                bestImageMeta = imageMeta;
//            }
//            else {
...
//    }
//
//    private List<InstagramFeedItem> getUserStories(long userPk) {
//        List<InstagramFeedItem> items = null;
//        InstagramUserStoryFeedResult result = null;
//
//        try {
//            result = instagram.sendRequest(new InstagramUserStoryFeedRequest("" + userPk));
//            if (result != null && result.getReel() != null) {
//                items = result.getReel().getItems();
//            }
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
